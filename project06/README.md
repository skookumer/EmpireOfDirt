...
Linh: Though I have familiarity with phylogenetic tree building with NJ, I have always built trees using packages and software, so this was my first time actually programming the algorithm. This has significantly deepened my understanding of how distance-based phylogenetic trees work, and also contributed to my growing familiarity with recursive algorithms. Through working on this project, there were many times where concepts I thought were largely unrelated suddenly became clearly linked to me after a few steps of derivation deeper than what my previous courses had exposed. And sometimes, understanding an algorithm's steps and logic still does not seamlessly translate into knowing how to code it. Additionally, this project involved a lot of documentation reading which is always good to practice.
